...
const { arrow, bg, elementImage, imageText, lists, shape, tagLine, text, title, videoId } = aboutOneData
    ...
    return (
        <>
            <section className="about-one">
                ...
                <div className="about-one__shape" style={{ backgroundImage: `url(${shape.src})` }}></div>
                <Container >
                    <Row >
                        <Col xl={6} data-aos='fade-right'
                            ...
                            <div className="about-one__content">
                                <div className="sec-title text-left">
                                    <h6 className="sec-title__tagline"><span className="sec-title__tagline__left"></span>{tagLine} Our About Now<span className="sec-title__tagline__right"></span></h6>
                                ...
                                <div className="about-one__content__btn">
                                    ...
                                    <Image className="about-one__content__btn__arrow" src={arrow} alt="tolak" />
                                </div>
                        ...
                        <Col xl={6} >
                            <div ref={el => elementsRef.current[0] = el} className="tolak-stretch-element-inside-column">
                                <div className="about-one__image" data-aos='slide-left'
                                    data-aos-easing='linear'
